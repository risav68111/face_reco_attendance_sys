...
class Face:
    def __init__(self, root):
        ...
        btn_update = Button(self.root, text="Open Camera", activebackground='#df2121',command=self.faceReco, fg='black',
            ...
            for(x, y, w, h) in faces:
                ...
                try:
                    ...
                    if confidence>80:
                        ...
                        attend_file= createAttendanceFile()
                        with open(attend_file, "r+", newline="\n") as f:
    ...
    def createAttendanceFile(self):
        current_date = datetime.now().strftime("%Y-%m-%d")
        file_name = f"attend_{current_date}.csv"

        if not os.path.exists(file_name):
            with open(file_name, "w") as file:
                file.write("Name, Roll No, Department, Date, Time\n")
